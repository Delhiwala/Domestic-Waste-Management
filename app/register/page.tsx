      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-emerald-800">Create EcoWaste Account</h1>
            <p className="mt-2 text-gray-600">Join our community for smarter waste management</p>
          </div>
